...
/**
 * Core constants that are reused through the core of the application Guidelines: Anything that is
 * continuously retyped in subclasses, components, configuration files should be placed in this
 * file.
 */
